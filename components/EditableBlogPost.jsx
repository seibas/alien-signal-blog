  ...
  if (isEditing) {
    ...
    return (
      <article className="article">
          ...
          <div className="edit-section">
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <button className="btn" type="button" onClick={() => {
                ...
                setTimeout(() => setWritingModeBlockIndex(editedPost.blocks.length), 0);
        ...
        {writingModeBlockIndex !== null && editedPost.blocks[writingModeBlockIndex] && (
          <div
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="writing-mode-container">
              ...
              <div className="writing-mode-body">
                ...
                <textarea
                  autoFocus
                  value={editedPost.blocks[writingModeBlockIndex]?.value || ''}
                ...
                <div style={{ marginTop: 20 }}>
                  <ImageUpload onImageInsert={(markdown) => {
                    handleBlockChange(writingModeBlockIndex, (editedPost.blocks[writingModeBlockIndex]?.value || '') + '\n\n' + markdown);
                  }} />
                </div>
              </div>
